...
<template>
  ...
  <p class="text-sm text-gray-500"><b>Tipp</b>: Nutze einen Passwortmanager wie KeepassXC für starke Passwörter.</p>

  <div class="grid grid-cols-5 gap-2 mb-2 w-full">
    <div
      v-for="i in 5"
      :key="'level' + i"
      class="rounded-full h-2 bg-neutral-200 relative overflow-hidden"
    >
      <div
  ...
  <div class="flex flex-col space-y-2 text-sm mb-4">
    <div
      ...
      :class="level >= 1 ? 'text-primary-500' : 'text-neutral-500'"
    >
      <component
    ...
    <div
      class="flex items-center space-x-2"
      :class="level >= 2 ? 'text-primary-500' : 'text-neutral-500'"
    >
      <component
    ...
    <div
      class="flex items-center space-x-2"
      :class="level >= 3 ? 'text-primary-500' : 'text-neutral-500'"
    >
      <component
    ...
    <div
      class="flex items-center space-x-2"
      :class="level >= 4 ? 'text-primary-500' : 'text-neutral-500'"
    >
      <component
    ...
    <div
      class="flex items-center space-x-2"
      :class="level >= 5 ? 'text-primary-500' : 'text-neutral-500'"
    >
      <component
